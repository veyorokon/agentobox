...
class EventSender:
    ...
    def _emit_overflow_event(self, evicted_seq: int):
        ...
        # If the buffer is full, appending will evict another event.
        # We accept this — the overflow event is more informative than
        # the oldest buffered event at this point.
