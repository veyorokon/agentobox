...
export type ActivityState = "thinking" | "coding" | "browsing" | "blocked" | "needs-you" | "idle" | "done"
export type ArtifactKind = "code" | "test" | "config" | "env" | "doc"
...
export const MOCK_WORK_ITEMS: WorkItem[] = [
  {
    ...
    artifacts: [
      { path: "backend/middleware/auth.py", action: "created", lines: 84, kind: "code", lang: "py" },
      { path: "backend/routes/agents.py", action: "modified", lines: 12, kind: "code", lang: "py" },
      { path: "backend/routes/projects.py", action: "modified", lines: 8, kind: "code", lang: "py" },
      { path: "backend/tests/test_auth_middleware.py", action: "created", lines: 47, kind: "test", lang: "py" },
    ],
    terminalOutput: [
  ...
  },
  {
    ...
    artifacts: [
      { path: ".deploy.env", action: "created", lines: 34, kind: "env" },
    ],
    terminalOutput: [
  ...
  },
  {
    ...
    artifacts: [
      { path: "backend/tests/test_feed_resolvers.py", action: "created", lines: 186, kind: "test", lang: "py" },
      { path: "backend/tests/conftest.py", action: "modified", lines: 23, kind: "code", lang: "py" },
    ],
    terminalOutput: [
  ...
  },
  {
    ...
    artifacts: [
      { path: "dashboard/components/agent/vnc-thumbnail.tsx", action: "modified", lines: 18, kind: "code", lang: "tsx" },
    ],
    terminalOutput: [
