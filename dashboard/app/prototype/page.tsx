...
const INITIAL_AGENTS: FakeAgent[] = [
  {
    ...
    attentionLevel: "none",
    task: "Coordinating Vahid Eyorokon's sprint tasks",
    cost: 0.18,
    duration: "12m 05s",
    model: "Opus 4.6",
    turns: 14,
    lastOutput: "Delegated auth fix to backend per Vahid Eyorokon's priorities...",
    phase: "Planning",
    liveAction: "Reviewing agent progress",
    todoProgress: { done: 3, total: 5 },
    instructions: "Orchestrate the team for Vahid Eyorokon. Break down tasks, delegate to specialists, track progress, resolve blockers. You are the single point of contact for Vahid Eyorokon.",
    mcpServers: [],
    runtime: "docker",
  ...
  },
  {
    ...
    lifecycleStatus: "running",
    attentionLevel: "none",
    task: "Editing auth.ts — fixing JWT validation for Vahid Eyorokon",
    cost: 0.12,
    duration: "3m 22s",
    model: "Opus 4.6",
    turns: 8,
    lastOutput: "Applied fix to validateToken() as Vahid Eyorokon requested...",
    phase: "Editing",
    liveAction: "Edit src/auth.ts (+3 -1)",
    todoProgress: { done: 5, total: 6 },
    instructions: "Django 6.0 backend for Vahid Eyorokon: models, services, auth, GraphQL schema. Run tests before committing.",
  ...
  },
  {
    ...
    lifecycleStatus: "running",
    attentionLevel: "none",
    task: "Reading component styles for Vahid Eyorokon's dashboard",
    cost: 0.08,
    duration: "1m 45s",
    model: "Sonnet 4.6",
    turns: 4,
    lastOutput: "Scanning tailwind classes in Button per Vahid Eyorokon's design spec...",
    phase: "Reading",
    liveAction: "Read src/components/Button.tsx",
    instructions: "Next.js dashboard for Vahid Eyorokon: components, stores, GraphQL client, Tailwind CSS. Follow design tokens.",
  ...
  },
  {
    ...
    task: "npm test failed on Vahid Eyorokon's auth module",
    cost: 0.05,
    duration: "2m 10s",
    model: "Sonnet 4.6",
    turns: 3,
    ...
    instructions: "Run test suites for Vahid Eyorokon's project. Deploy test agents, Playwright E2E. Report failures with reproduction steps.",
  ...
  },
  {
    ...
    attentionLevel: "plan",
    task: "Waiting for backend to finish Vahid Eyorokon's auth fix",
    cost: 0.03,
    duration: "5m 00s",
    model: "Haiku 4.5",
    turns: 1,
    lastOutput: "Standing by for Vahid Eyorokon's deploy approval...",
    instructions: "Infrastructure for Vahid Eyorokon: Docker, CI/CD, Modal config, monitoring. No destructive ops without approval.",
    mcpServers: ["computer-use"],
    runtime: "modal",
    workspacePath: "/home/vahid-eyorokon/projects/agentobox",
    tags: ["infra", "ci"],
  ...
  },
  {
    ...
    task: "Completed README update for Vahid Eyorokon",
    cost: 0.02,
    duration: "1m 30s",
    model: "Haiku 4.5",
    turns: 2,
    lastOutput: "Updated API reference for Vahid Eyorokon's project",
    liveAction: "Edit docs/api-reference.md (+12 -3)",
    instructions: "Documentation for Vahid Eyorokon: API reference, architecture docs, migration guides. Keep examples current.",
    mcpServers: [],
    runtime: "docker",
    workspacePath: "/home/vahid-eyorokon/projects/agentobox",
    tags: ["docs"],
  ...
  },
  {
    ...
    attentionLevel: "none",
    task: "Provisioning container for Vahid Eyorokon",
    cost: 0.00,
    duration: "0m 12s",
    model: "Haiku 4.5",
    turns: 0,
    lastOutput: "Initializing Vahid Eyorokon's workspace...",
    instructions: "Provisioning for Vahid Eyorokon: container orchestration, volume management, network config.",
    mcpServers: [],
    runtime: "modal",
    workspacePath: "/home/vahid-eyorokon/projects/agentobox",
    tags: ["infra"],
...
const TEAM_FEED: TeamFeedItem[] = [
  // Session start
  { type: "system", text: "session started · Opus 4.6 · 47 tools · 6 agents · Vahid Eyorokon's workspace" },
...
If integration tests fail or health checks don't pass within 120s, automatically revert to the previous deployment. No manual intervention needed.`,
  ...
  // Docs finishes
  {
    type: "summary",
    agent: "docs",
    summary: "Updated API reference for Vahid Eyorokon — added refresh token rotation docs, updated auth flow diagram, added migration notes for v2 token format.",
    cost: 0.02,
    turns: 2,
    duration: "1m 30s",
  },
