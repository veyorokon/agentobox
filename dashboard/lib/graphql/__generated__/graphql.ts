...
export type CreateAgentMutation = { __typename?: 'Mutation', createAgent: { __typename?: 'AgentType', id: string, name: string, lifecycleStatus: string, attentionLevel: string, mode: string, task: string, cost: number, duration: string, model: string, turns: number, phase: string, liveAction?: string | null, lastOutput: string, tags: unknown, instructions: string, mcpServers: Array<string>, runtime: string, workspacePath: string, taskProgress?: { __typename?: 'TaskProgressType', done: number, total: number } | null } };
...
export type GetProjectQuery = { __typename?: 'Query', project?: { __typename?: 'ProjectType', id: string, name: string, description: string } | null };
