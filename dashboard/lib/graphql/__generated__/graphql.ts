...
export type AgentType = {
  ...
  isConverged: Scalars['Boolean']['output'];
...
export type IncidentCaptureResult = {
  __typename?: 'IncidentCaptureResult';
...
export type IncidentCaptureType = {
  __typename?: 'IncidentCaptureType';
  agentId: Scalars['ID']['output'];
  bundle: Scalars['JSON']['output'];
  collectionErrors: Scalars['JSON']['output'];
  createdAt: Scalars['String']['output'];
...
export type Mutation = {
  ...
  captureIncident: IncidentCaptureResult;
...
export type MutationCaptureIncidentArgs = {
...
export type Query = {
  ...
  incident?: Maybe<IncidentCaptureType>;
...
export type ClearAgentSessionMutation = { __typename?: 'Mutation', clearAgentSession: boolean };
...
export type CaptureIncidentMutationVariables = Exact<{
  input: CaptureIncidentInput;
}>;


export type CaptureIncidentMutation = { __typename?: 'Mutation', captureIncident: { __typename?: 'IncidentCaptureResult', incidentId: string, agentId: string, projectId: string, createdAt: string } };
...
export type GetAgentsQuery = { __typename?: 'Query', agents: Array<{ __typename?: 'AgentType', id: string, name: string, lifecycleStatus: string, previewState: string, previewRuntimeId: string, attentionLevel: string, relayConnected: boolean, mode: string, task: string, cost: number, duration: string, model: string, turns: number, phase: string, liveAction?: string | null, lastOutput: string, errorMessage: string, tags: unknown, instructions: string, mcpServers: Array<string>, mcpConfig: unknown, runtime: string, workspacePath: string, triggers: unknown, computeSeconds: number, taskProgress?: { __typename?: 'TaskProgressType', done: number, total: number } | null, tasks: Array<{ __typename?: 'AgentTaskType', taskId: string, title: string, description: string, status: string, assignee: string, activeForm: string, blockedBy: Array<string>, createdAt: string, updatedAt: string }> }> };
...
export const ClearAgentSessionDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"ClearAgentSession"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"agentId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"clearAgentSession"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"agentId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"agentId"}}}]}]}}]} as unknown as DocumentNode<ClearAgentSessionMutation, ClearAgentSessionMutationVariables>;
...
export const CaptureIncidentDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"CaptureIncident"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"CaptureIncidentInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"captureIncident"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"incidentId"}},{"kind":"Field","name":{"kind":"Name","value":"agentId"}},{"kind":"Field","name":{"kind":"Name","value":"projectId"}},{"kind":"Field","name":{"kind":"Name","value":"createdAt"}}]}}]}}]} as unknown as DocumentNode<CaptureIncidentMutation, CaptureIncidentMutationVariables>;
